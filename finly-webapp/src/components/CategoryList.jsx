                        ...
                        className="group relative flex items-center gap-4 p-3 rounded-lg hover:bg-gray-200/60">
                            ...
                            <div className="w-12 h-12 flex  items-center justify-center text-xl text-gray-800 bg-emerald-100 rounded-full">
                                {category.icon ? (
                                    ...
                                    <Layers2 className="text-primary text-emerald-600"  size={24}/>
                                )}
                            </div>
                            ...
                            <div className="flex items-center gap-2">
                                <button className="text-gray-400 hover:text-green-800 opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer">
                                    <Pencil size={18}/>
                                </button>
                            </div>
                        </div>
